package com.ruanmeng.project_model.myrecyclerview.bgarefresh.bgarefreshlayoutviewholder;
/**
...
public class DefineBAGRefreshWithLoadView extends BGARefreshViewHolder {
    ...
    private String mRefreshingText = "正在拼命加载中!!...";
    ...
    /**
     * @param context
     * @param isLoadingMoreEnabled 是否加载更多
     * @param isRefreshEnabled     是否刷新
     */
