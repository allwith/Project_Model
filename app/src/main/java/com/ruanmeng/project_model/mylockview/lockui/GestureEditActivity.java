...
import com.ruanmeng.project_model.mylockview.widget.LockIndicator;
...
//							 清除画下的线
						...
						if (mIsFirstInput) {
							...
							if (inputCode.equals(mFirstPassword)) {
								...
								SPUtils.put(com.ruanmeng.Application.getContext(),
										"MyGesturePsd", inputCode);
//
								mGestureContentView.clearDrawlineState(0L);
