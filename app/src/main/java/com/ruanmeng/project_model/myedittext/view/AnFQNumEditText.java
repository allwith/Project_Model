package com.ruanmeng.project_model.myedittext.view;
...
////        设置字体颜色
//        etContent.setTextColor(getEtColor());
////        设置字体大小
//        etContent.setTextSize(getEtTextSize());
        return this;
    }
...
//    {
//        return  etContent.getCurrentTextColor();
//    }

    public  AnFQNumEditText  setEtColor(int  id)
    {
//        etContent.setTextColor(color);
        et_TextColor=getResources().getColor(id);
        etContent.setTextColor(et_TextColor);
        return  this;
    }
...
//
//        return  etContent.getTextSize();
//    }
    public  AnFQNumEditText  setEtTextSize(float mysize){
//        etContent.setTextSize(mysize);
        et_TextSize=mysize;
        etContent.setTextSize(et_TextSize);
        return  this;
    }
