...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) Application.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        ToastUtil.shortShow("已复制到剪贴板");
    CommonUtil.showToask(context,"已复制到剪贴板");
    }
